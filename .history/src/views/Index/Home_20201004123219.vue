        ...
        <section id="home">
            <div class="container">
                <div class="row space-100">
                    <div class="contents">
                        <h2 class="head-title">Giải Pháp Quản Lí Trường Học</h2>
                        <p>
                            back-to-topease, Purchase full version of Slick to
                            get all pages, features and permission to use in
                            commercial projects
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-12">
                        <div class="services-item text-center">
                            ...
                            <h4>Bootstrap 4</h4>
                            <p>
                                Share processes and data secure lona need to
                                know basis Our team assured your web site is
                                always safe.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 p-0">
                        ...
                        <div class="feature-item featured-border1">
                            ...
                            <div class="feature-info float-left">
                                ...
                                <p>
                                    Producing long lasting organic SEO results
                                    for <br />
                                    brand of different kinds for more than a
                                    decade,<br />
